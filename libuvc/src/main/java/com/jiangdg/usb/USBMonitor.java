...
public final class USBMonitor {
    ...
    public USBMonitor(final Context context, final OnDeviceConnectListener listener) {
        ...
        destroyed = false;
        if (DEBUG) {
            XLogWrapper.v(TAG, "USBMonitor:mUsbManager=" + mUsbManager);
        }
    }
    ...
    public static final String getDeviceKeyName(final UsbDevice device, final String serial, final boolean useNewAPI) {
        ...
        /*if (DEBUG) {
            XLogWrapper.v(TAG, "getDeviceKeyName:" + sb.toString());
        }*/
        return sb.toString();
    }
    ...
    public synchronized boolean requestPermission(final UsbDevice device) {
        /*if (DEBUG) {
            XLogWrapper.v(TAG, "requestPermission:device=" + device);
        }*/
    ...
    public static final class UsbControlBlock implements Cloneable {
        ...
        public synchronized void close() {
            if (DEBUG) {
                XLogWrapper.i(TAG, "UsbControlBlock#close:");
            }
            if (mConnection != null) {
