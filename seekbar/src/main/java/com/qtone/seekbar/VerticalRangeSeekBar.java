...
public class VerticalRangeSeekBar extends RangeSeekBar {
    // text direction of VerticalRangeSeekBar
    // include indicator and tickMark
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        } else if (widthMode == MeasureSpec.AT_MOST && getParent() instanceof ViewGroup && widthSize == ViewGroup.LayoutParams.MATCH_PARENT) {
        ...
        if (getTickMarkTextArray() != null) {
            ...
            for (int i = 0; i < arrayLength; i++) {
                ...
                if (getTickMarkMode() == TRICK_MARK_MODE_OTHER) {
                    ...
                    // 按实际比例显示
                    x = getProgressLeft() + getProgressWidth() * (num - getMinProgress()) / (getMaxProgress() - getMinProgress()) - tickMarkTextRect.width() / 2f;
                }
                float y;
     ...
     *
     * @param tickMarkDirection TickMarkDirection
     */
