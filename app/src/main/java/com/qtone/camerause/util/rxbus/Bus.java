package com.qtone.camerause.util.rxbus;

import com.qtone.camerause.util.rxbus.annotation.Tag;
import com.qtone.camerause.util.rxbus.entity.DeadEvent;
import com.qtone.camerause.util.rxbus.entity.EventType;
import com.qtone.camerause.util.rxbus.entity.ProducerBaseEvent;
import com.qtone.camerause.util.rxbus.entity.SubscriberBaseEvent;
import com.qtone.camerause.util.rxbus.finder.Finder;
import com.qtone.camerause.util.rxbus.thread.ThreadEnforcer;
 ...
 * desired;</li>
 * <li>Mark it with a {@link com.qtone.camerause.util.rxbus.annotation.Subscribe} annotation;</li>
 ...
 * enforcement by passing a {@link com.qtone.camerause.util.rxbus.thread.ThreadEnforcer} to the constructor.
 * <p/>
 ...
 * second chance to handle dead events, they are wrapped in an instance of {@link com.qtone.camerause.util.rxbus.entity.DeadEvent} and reposted.
 * <p/>
...
public class Bus {
    ...
    public void register(Object object) {
        ...
        for (EventType type : foundProducers.keySet()) {
            ...
            if (null != previousProducer) {
                if (null != producer) {
                    throw new IllegalArgumentException("Producer method for type " + type + " found on type " + producer.getTarget().getClass() + ", but already registered by type " + previousProducer.getTarget().getClass() + ".");
                }
            }
     ...
     * <p/>
     * If no subscribers have been subscribed for {@code event}'s class, and {@code event} is not already a {@link com.qtone.camerause.util.rxbus.entity.DeadEvent}, it will be wrapped in a DeadEvent and reposted.
     *
